/**
 * ISO 3166-1 alpha-2 countries with E.164 dial codes.
 * Flags are rendered from the ISO-2 code as regional-indicator emoji at runtime —
 * no image assets, so this stays air-gap / on-prem friendly.
 */
export type Country = { iso2: string; name: string; dial: string };

/** Turn an ISO-2 code (e.g. "GH") into its flag emoji (🇬🇭). */
